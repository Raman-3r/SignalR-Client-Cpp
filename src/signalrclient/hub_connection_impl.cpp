...
namespace signalr
{
    ...
    std::shared_ptr<hub_connection_impl> hub_connection_impl::create(const std::string& url, std::shared_ptr<scheduler> scheduler, trace_level trace_level,
    ...
    {
        auto connection = std::shared_ptr<hub_connection_impl>(new hub_connection_impl(url, scheduler, trace_level, log_writer, http_client, websocket_factory));
